...
def mongo_insert(data):
    client = pymongo.MongoClient("mongodb://mongoUser:Mongo123@netology-hw-cluster-shard-00-00-czw7w.mongodb.net:27017,\
                                 netology-hw-cluster-shard-00-01-czw7w.mongodb.net:27017,\
                                 netology-hw-cluster-shard-00-02-czw7w.mongodb.net:27017/test?ssl=true&replicaSet=Netology-HW-cluster-shard-0&authSource=admin&retryWrites=true&w=majority")
    db = client.diploma
